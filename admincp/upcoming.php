...
if (isset($_POST['submit'])) {
   ...
   $sql = "UPDATE event SET location = '$loc' WHERE id = 1";
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form method="POST" action="">
                                <label for="email_address">Upcoming Events</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <textarea type="text" id="email_address" class="form-control" placeholder="Enter Here" name="location" required=""></textarea>
