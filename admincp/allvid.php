                                ...
                                <tbody>
                                    <?php
                                     ...
                                     $page = filter_var(isset($_GET['page']) ? $_GET['page'] : 1,FILTER_SANITIZE_STRING);
                                      $start = ($page - 1) * $limit;
                                    $sql = "SELECT * FROM video LIMIT $start,$limit";
                                    $data = mysqli_query($con,$sql);
                                    $result1 = $con->query("SELECT count(id) AS id FROM video");
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="delvid?id=<?php echo $row['id'];?>" type="button"
                                                class="btn bg-red btn-circle waves-effect waves-circle waves-float">
                                                <i class="material-icons">delete</i>
                                            </a>
                                            <a href="videoupload/<?php echo $row['name'];?>" type="button"
