                                ...
                                <thead>
                                 ...
                                 <?php
                                     ...
                                     $page = filter_var(isset($_GET['page']) ? $_GET['page'] : 1,FILTER_SANITIZE_STRING);
                                      $start = ($page - 1) * $limit;
                                    $sql = "SELECT * FROM payment LIMIT $start,$limit";
                                    $data = mysqli_query($con,$sql);
                                    $result1 = $con->query("SELECT count(id) AS id FROM payment");
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="ss/<?php echo$row['ss'] ;?>">view</a>
                                        </td>
                                         <td><?php echo $row['msg']; ?></td>
                                        <td><?php echo $row['date']; ?></td>
                                        <td>
                                            <a href="del_pay?id=<?php echo $row['id'];?>" type="button"
