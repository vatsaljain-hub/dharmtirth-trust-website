                ...
                <h2>
                    ...
                    if (isset($_GET['msg'])) {
                     echo '<div class="alert alert-danger">
                                <strong>Important!</strong> Deleted successfully.
                            </div>';
                    }
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th> NAME</th>
                                        <th> MOBILE</th>
                                        <th style="text-transform: uppercase;"> designation</th>
                                         <th>PHOTO</th>
                                        <th>Date Added</th>
                                ...
                                <tbody>
                                    <?php
                                     ...
                                     $page = filter_var(isset($_GET['page']) ? $_GET['page'] : 1,FILTER_SANITIZE_STRING);
                                      $start = ($page - 1) * $limit;
                                    $sql = "SELECT * FROM trust LIMIT $start,$limit";
                                    $data = mysqli_query($con,$sql);
                                    $result1 = $con->query("SELECT count(id) AS id FROM trust");
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="trustph/<?php echo$row['photo'] ;?>" style="height: 50px;width:50px;">
                                            <a href="trustph/<?php echo$row['photo'] ;?>">view</a>
                                           
                                        </td>
                                
                                        <td><?php echo $row['date']; ?></td>
                                        <td>
                                            <a href="del_trust?id=<?php echo $row['id'];?>" type="button"
