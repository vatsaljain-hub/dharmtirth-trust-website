...
if (isset($_POST['submit'])) {
   ...
   $city = filter_var($_POST['v'],FILTER_SANITIZE_STRING);
   $pad = $_POST['st'];

    $date = date('d-m-yy');
    $sql = "INSERT INTO doner VALUES (NULL,'$name','$city','$date','$pad') ";
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form method="POST" action="" enctype="multipart/form-data">
                                ...
                                <label for="email_address">Village or City</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="email_address" class="form-control" placeholder="Enter here" name="v" required="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                      <select class="form-control show-tick" name="st">
                                        <option value="गोग्रास">गोग्रास</option>
                                        <option value="आहारदान">आहारदान</option>
                                        <option value="महाशांतिधारा">महाशांतिधारा</option>
                                        <option value="विधान">विधान</option>
                                ...
                                <a href="viewdn?menu=upa"  class="btn btn-success m-t-15 waves-effect" name="submit" name="view">VIEW ALL</a>
                            </form>
                        </div>
                    </div>
                </div>
