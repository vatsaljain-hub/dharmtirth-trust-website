                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Contact Information
                                <small>this are the messages are send from website contact form</small>
                            </h2>
                        ...
                        <div class="body table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    $result1 = $con->query("SELECT count(id) AS id FROM guru");
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                              ...
                                              <a href="../read?val=<?php echo$en_id;?>" type="button"
                                                class="btn bg-green btn-circle waves-effect waves-circle waves-float">
                                                <i class="material-icons">visibility</i>
                                            </a>
                                            <a href="delguru?id=<?php echo $row['id'];?>" type="button"
