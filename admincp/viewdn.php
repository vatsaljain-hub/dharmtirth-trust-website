                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                      ...
                                      <th scope="col" style="text-transform: uppercase;">Donated for</th>
                                ...
                                <tbody>
                                    <?php
                                     ...
                                     $page = filter_var(isset($_GET['page']) ? $_GET['page'] : 1,FILTER_SANITIZE_STRING);
                                      $start = ($page - 1) * $limit;
                                    $sql = "SELECT * FROM doner LIMIT $start,$limit";
                                    $data = mysqli_query($con,$sql);
                                    $result1 = $con->query("SELECT count(id) AS id FROM doner");
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['dfor']; ?></td>
                                       
                                        <td><?php echo $row['datea']; ?></td>
                                        <td>
                                            <a href="deldn?id=<?php echo $row['id'];?>" type="button"
