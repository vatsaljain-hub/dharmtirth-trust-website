...
if (isset($_POST['submit'])) {
  ...
  {  
    $upload_video = move_uploaded_file($file_vi, $destination_pdf);
     if ($upload_video) 
     {
       $sql = "INSERT INTO gallery VALUES (null,'$pdf','$date','$size')";
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Gallery
                                <small>IMAGES WILL DISPLAY IN GALLERY OF WEBSITE</small>
                                <?php echo $done; ?>
                            </h2>
                        ...
                        <div class="body">
                            <form action="" id="frmFileUpload" method="post" enctype="multipart/form-data"
                                ...
                                <div class="dz-message">
                                    ...
                                    <h3>Add photos to website Gallery</h3>
...
<br>
                                <div class="row clearfix">
                                 ...
                                 <div class="container">
                                    ...
                                    <a href="imagegallery?menu=gallery" type="button" class="btn bg-deep-purple waves-effect">
