            ...
            <div class="row clearfix">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-pink hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">TOTAL PDF</div>

                            <div class="number count-to" data-from="0" data-to="<?php
                  error_reporting(0);
                     $query = "SELECT * FROM pdf";
                     $fetch_dn = mysqli_query($con,$query);
          
                     if ($ipcon = mysqli_num_rows($fetch_dn)) {
             echo $ipcon;
                       while ($row_dn = mysqli_fetch_assoc($fetch_dn)) {
                         $sum = $row_dn['id'];

                       }
                     }
                     // echo $sum;
                  ?>" data-speed="2000" data-fresh-interval="2000"></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
