...
if (isset($_POST['submit'])) {
    ...
    $destination_pdf = '../admincp/recent/'. $pdf;
  ...
  {  
    $upload_video = move_uploaded_file($file_vi, $destination_pdf);
     if ($upload_video) 
     {
       $sql = "INSERT INTO recent VALUES (null,'$name','$date','$pdf','$size')";
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                RECENT PROGRAMS
                                <small>RECENT PROGRAMS IMAGES WILL DISPLAY IN RECENT PROGRAM PAGE OF WEBSITE</small>
                                <?php echo $done; ?>
                            </h2>
...
<br>
                                <div class="row clearfix">
                                    ...
                                    <a href="allrecent?menu=pro" type="button" class="btn bg-deep-purple waves-effect">
                                    <i class="material-icons">photo_library</i>
